...
# ------------------------------------------------------------------------------
# We generated the train--test splits using the following code. The 500 pairs we used are in the `data/ts-splits` folder. 
# NOTE: It will overwrite the ts-splits that we used for the paper. For this reason, I commented out the code; uncomment it before you run.
